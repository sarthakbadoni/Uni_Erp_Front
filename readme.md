...
To make the ERP easier to use and reduce repeated “how do I do this?” questions, we also plan to add a small in‑built **FAQ helpbot** inside the system.

- It will live inside the interface as a simple help/chat button.  
- Students and faculty will be able to ask common questions like:
  - “How do I check my attendance?”
  - “Where can I see my results?”
  - “How do I download my fee receipt?”
- The helpbot will reply with quick answers and, wherever possible, directly guide users to the relevant page inside the ERP.

This is meant to make the system more self‑explanatory, especially for first‑time users.
